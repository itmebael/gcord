...
(function () {
  ...
  var MENU = [
    ...
    { page: 'transactions', href: 'dashboard.html#transactions', label: 'My<br>Transactions', icon: ICON.transactions },
    { page: 'scan', href: 'scan.html', label: 'Scan &amp; Record', icon: ICON.scan },
    { page: 'duplicate', href: 'duplicate.html', label: 'Duplicate<br>Management', icon: ICON.duplicate },
    { page: 'reports', href: 'reports.html', label: 'Reports &amp;<br>Analytics', icon: ICON.reports },
    { page: 'profile', href: 'profile.html', label: 'Profile<br>Management', icon: ICON.profile },
  ...
  var MOBILE_NAV_CSS =
    ...
    'width:min(300px,86vw)!important;height:100vh!important;height:100dvh!important;' +
